...
//   const { anonymousLogin, isLoggingIn } = useAuthStore(); // Get anonymousLogin from the store
  ...
  return (
    <div className="font-[inter] sticky bottom-20 lg:bottom-2 left-0 right-0 bg-base-200  p-4 z-999999 l rounded-none md:mx-4 md:mb-4 flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 animate-slide-up">
