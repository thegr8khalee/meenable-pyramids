...
import { Loader2, ShoppingCart, Pen, Trash2, ChevronLeft, Share2 } from 'lucide-react';
...
const RecipePage = () => {
  ...
  const { recipe, getRecipeById, isGettingRecipe, isDeletingRecipe, deleteRecipe } = useAdminStore();
  ...
  const handleImageError = (e) => {
    ...
    e.target.src = 'https://placehold.co/600x400/E0E0E0/333333?text=No+Image+Available';
  };
    ...
    <div className="items-center flex flex-col">
      ...
      <div className="flex flex-col gap-4 bg-base-100 px-4 rounded-none shadow-xl max-w-5xl w-full">
        ...
        <div className=" flex flex-col items-center">
          <div className="relative w-full  rounded-none overflow-hidden flex items-center justify-center">
            {recipe.image ? (
              <img
        ...
        <div className=" space-y-2">
          <h1 className="text-3xl font-bold font-[poppins] capitalize">{recipe.name}</h1>
          ...
          <div className="prose text-gray-700">
            ...
            <ul className="list-disc list-inside">
              {recipe.ingredients && recipe.ingredients.length > 0 ? (
                // This assumes `recipe.products` has been populated with product details in the store
                // If not, you would need to fetch product data here
          ...
          {!isAdmin ? (
            ...
            <div className="space-y-2 pt-4">
              ...
              >
                {isDeletingRecipe ? <Loader2 className="animate-spin" /> : <Trash2 />} Delete Recipe
              </button>
            </div>
          )}
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl text-center">
            ...
            <p className="mb-6">This action will permanently delete this recipe.</p>
